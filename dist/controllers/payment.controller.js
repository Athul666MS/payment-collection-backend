...
exports.getPaymentHistory = exports.makePayment = void 0;
const catchAsync_1 = __importDefault(require("../utils/catchAsync"));
const paymentService = __importStar(require("../services/payment.service"));
exports.makePayment = (0, catchAsync_1.default)(async (req, res) => {
...
exports.getPaymentHistory = (0, catchAsync_1.default)(async (req, res) => {
